...
<body>
	<div class="maincontainer">
		...
		<form action="staffsignup" method="post" target="_self"
			autocomplete="off">
			<table>
				<tr>
				...
				<tr>
					...
					<td><input type="password" id="createpass" name="createpass"
				...
				<tr>
					...
					<td><input type="text" id="gen" name="gen"
